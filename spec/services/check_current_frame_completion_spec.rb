    ...
    context 'when the game is started' do
      context 'and is not the last frame' do
        context 'and it was the first delivery' do
          context 'and it was a strike' do
            it 'finishes the frame' do
              frame = create(:frame, number: 1, kind: :strike, first_delivery: 10)
        ...
        context 'and it was the second delivery' do
          context 'and it was a spare' do
            it 'finishes the frame' do
              frame = create(:frame, number: 1, kind: :spare, first_delivery: 9, second_delivery: 1)
      ...
      context 'and is the last frame' do
        context 'and it was the first delivery' do
          context 'and it was a strike' do
            it 'does not finish the frame' do
              frame = create(:frame, number: 10, kind: :strike, first_delivery: 10)
        ...
        context 'and it was the second delivery' do
          context 'and it was a strike' do
            it 'does not finish the frame' do
              frame = create(:frame, number: 10, kind: :strike, first_delivery: 10, second_delivery: 0)
          ...
          context 'and it was a spare' do
            it 'does not finish the frame' do
              frame = create(:frame, number: 10, kind: :spare, first_delivery: 9, second_delivery: 1)
        ...
        context 'and it was the third delivery' do
          context 'and it was a strike' do
            it 'finishes the frame' do
              frame = create(:frame, number: 10, kind: :strike, first_delivery: 10, second_delivery: 5, third_delivery: 5)
          ...
          context 'and it was a spare' do
            it 'finishes the frame' do
              frame = create(:frame, number: 10, kind: :spare, first_delivery: 5, second_delivery: 5, third_delivery: 5)
